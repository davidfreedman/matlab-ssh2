...
Uses ganymed-ssh2 library from http://www.cleondris.ch/ssh2. 
Included custom library can be used by changing the variable
 USE_CUSTOM_GANYMED_LIB in ssh2_setup.m to 1. 

See the example folder for many examples on how one can 
use the SSH-2 Matlab library. 

Upon first use, the official ganymed library will be downloaded and 
setup unless the included custom library is enabled. 
